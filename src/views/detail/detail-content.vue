  ...
  <section class="detail-content">
    <div class="detail-materials">
      ...
      <div class="detail-materials-box clearfix" >
        <h3>辅料</h3>
        <ul>
          <li class="" v-for="list in info.raw_material.accessories_material" :key="list._id">
            {{list.name}}
    ...
    <div class="detail-explain">
      <h2>菜的做法</h2>
      <section class="detail-section clearfix" v-for="(i,index) in info.steps" :key="i._id">
        <em class="detail-number">{{index+1}}.</em>
        <div class="detail-explain-desc">
          <p>{{i.describe}}</p>
          <img class="conimg" :src="i.img_url" alt="">
        </div>
      </section>
      <div class="skill">
        <h2>烹饪技巧</h2>
